                  ...
                  float *Variable)
{
    ...
    CROP->prm.MaxHeight = Variable[66];
    CROP->prm.RGL = Variable[67];
    CROP->prm.RadiationAttenuation = Variable[68];
    CROP->prm.WindAttenuation = Variable[69];
    CROP->prm.TrunkRatio = Variable[70];
...
void
FillManageVariables(Management *MNG,
                    float      *Variable)
{
    int i;
